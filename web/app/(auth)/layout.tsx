export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex w-full bg-[#0a0a0a]" style={{ fontFamily: "Manrope, system-ui, sans-serif" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-black overflow-hidden border-r border-[#242624]">
      ...
      <div className="w-full lg:w-1/2 relative flex flex-col justify-center items-center p-6 lg:p-12">
        ...
        <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#aeee2a]/10 via-transparent to-transparent pointer-events-none opacity-50" />
